		...
		<div class="login">
			<form action="processing.php" method="POST" autocomplete="on">
				...
				<div class="password">
					...
					<div class="tooltip">
						<input class="input-container" type="password" name="password_again" placeholder="enter your password once more" pattern="[a-z,A-Z,0-9]{5,20}" required maxlength="20" minlength="5">
						<span class="tooltiptext">Password is 5-20 alphabetical or number characters.</span>
					</div>
				</div>
				<div class="email">
					<label for="email">E-mail:</label>
					<input value="<?php echo $email; ?>" class="input-container" type="email" name="email" placeholder="enter your E-mail address">
				</div>
			...
			<p class="change-type">Already have account? Login <a href="login.php">HERE</a>.</p>
		</div>
	</div>
